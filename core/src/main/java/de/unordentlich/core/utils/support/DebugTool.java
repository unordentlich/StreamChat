...
import de.unordentlich.core.utils.support.objects.DebugEntry;
  ...
  private String prepareDebugLog() {
    ...
    log
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message1().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval2: ")
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message2().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval3: ")
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message3().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval4: ")
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message4().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval5: ")
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message5().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval6: ")
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message6().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval7: ")
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message7().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval8: ")
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message8().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval9: ")
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.autoBroadcastSubSettings().message9().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("interval10: ")
        ...
        .append(calculateSpaces(141 - 4 - 11,
            configuration.autoBroadcastSubSettings().message10().get().toString()))
        .append("#\n") // AutoBroadcast end
        .append(
        ...
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command1().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response1: ")
        .append(configuration.customCommandSubSettings().response1().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response1().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command2: ")
        .append(configuration.customCommandSubSettings().command2().get())
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command2().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response2: ")
        .append(configuration.customCommandSubSettings().response2().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response2().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command3: ")
        .append(configuration.customCommandSubSettings().command3().get())
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command3().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response3: ")
        .append(configuration.customCommandSubSettings().response3().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response3().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command4: ")
        .append(configuration.customCommandSubSettings().command4().get())
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command4().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response4: ")
        .append(configuration.customCommandSubSettings().response4().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response4().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command5: ")
        .append(configuration.customCommandSubSettings().command5().get())
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command5().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response5: ")
        .append(configuration.customCommandSubSettings().response5().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response5().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command6: ")
        .append(configuration.customCommandSubSettings().command6().get())
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command6().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response6: ")
        .append(configuration.customCommandSubSettings().response6().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response6().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command7: ")
        .append(configuration.customCommandSubSettings().command7().get())
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command7().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response7: ")
        .append(configuration.customCommandSubSettings().response7().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response7().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command8: ")
        .append(configuration.customCommandSubSettings().command8().get())
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command8().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response8: ")
        .append(configuration.customCommandSubSettings().response8().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response8().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command9: ")
        .append(configuration.customCommandSubSettings().command9().get())
        .append(calculateSpaces(141 - 4 - 10,
            configuration.customCommandSubSettings().command9().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response9: ")
        .append(configuration.customCommandSubSettings().response9().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().response9().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("command10: ")
        .append(configuration.customCommandSubSettings().command10().get())
        .append(calculateSpaces(141 - 4 - 11,
            configuration.customCommandSubSettings().command10().get().toString()))
        .append("#\n")
        .append(" #     ")
        .append("response10: ")
        .append(configuration.customCommandSubSettings().response10().get())
        .append(calculateSpaces(141 - 4 - 12,
            configuration.customCommandSubSettings().response10().get().toString()))
        .append("#\n") // CustomCommands end
        .append(
            " #                                                                                                                                               #\n")
        .append(
